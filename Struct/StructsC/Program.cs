...
namespace StructsC
{
    /*    **************************************************************
     *    
     *    STRUCT = Similar to class , but dont need to instanciate
     *    
     *    ***************************************************************/

    public struct Game  // Cannot Inheritance or abstract, but support Interface
    {
        public string name;
        ...
        //Cannot create default constructor
